...
Injector.prototype.inject = function(target, overrides, errorCallback) {

	if (typeof (overrides) === 'function') {
		errorCallback = overrides
		overrides = undefined		
	}
	...
	this._inject(target, params, realModule, dependency, [], this._handleError(errorCallback))
}
...
Injector.prototype.getDependencyByName = function(name) {
	...
	// maybe its a custom dependency, dont care if I return undefined here
	return this._customCache[name]
}
