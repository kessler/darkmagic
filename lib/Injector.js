...
Injector.prototype.inject = function(target, context) {
	...
	this._inject(target, context, module.parent || require.main, new Dependency(target.name || 'anonymous'), [])
}
...
function injectFunctor(injector, context, realModule, ancestors, dependency, parentDependency) {
	return function (callback) {
		...
		var artifact = dependency.load(realModule, injector._searchPaths, parentDependency)
