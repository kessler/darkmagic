...
Dependency.prototype.load = function (realModule, parentDependency) {
	...
	if (searchResults.length > 1) {
		throw new Error('multiple dependencies found for %s: %s, name collision must be resolved', this._name, pluck(searchResults, 'name'))
	}
...
Dependency.prototype._init = function (realModule, parentDependency) {
